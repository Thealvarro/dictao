; Custom NSIS template for Dictao with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Dictao for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Dictao releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Dictao Portable Mode"
    FileClose $0
